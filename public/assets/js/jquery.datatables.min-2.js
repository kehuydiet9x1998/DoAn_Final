...
(function(Fa, T, k) {
  var S = function(g) {
        ...
        for (e = h.length; d < e; d++) {
          ...
          for (b = h[d].length; f < b; f++)
            if (((n = j = 1), i[d][f] === k)) {
              ...
              for (
                i[d][f] = 1;
                h[d + j] !== k && h[d][f].cell == h[d + j][f].cell;
    ...
    function yb(a) {
      for (
        var b = m.ext.search, c = a.aiDisplay, d, e, f = 0, h = b.length;
        f < h;
        f++
      ) {
    ...
    var m,
      ...
      ia = function(a, b, c, d) {
        var e = [],
          f = 0,
          h = b.length;
        if (d !== k) for (; f < h; f++) a[b[f]][c] && e.push(a[b[f]][c][d]);
    ...
    m = function(a) {
      ...
      this.each(function() {
        ...
        if ("table" != this.nodeName.toLowerCase())
          ...
          if (f.aaData) for (e = 0; e < f.aaData.length; e++) L(o, f.aaData[e]);
          else
