                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6">
                    <div id="dom-table_filter" class="dataTables_filter" style="margin-left: -145px;">
                      <label style="display: flex">Search:<input type="search" class="form-control input-sm"
                        ...
                        <a href="{{URL::to('admin/lich-trai-nghiem/them')}}"  class="btn btn-success btn-round waves-effect waves-light"
                          style="margin-top: -6px;height: 35px;line-height: 13px; margin-left: 5px">Thêm lịch trải nghiệm</a>
                      </label>
                    </div>
                  </div>
                </div>
