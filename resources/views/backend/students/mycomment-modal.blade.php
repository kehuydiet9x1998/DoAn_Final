  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header" style="white-space: normal">
        <h4 class="modal-title">Nhận xét học sinh</h4>
        ...
        <form method="post" action="{{route('students.store')}}" novalidate="">
          <div class="modal-body">
            <h5 class="col-sm-12" style="font-weight: bold;
              padding-left: 0px; padding-bottom: 8px;border-bottom: 1px solid #cccccc">Thông tin nhận xét</h5>
            <div class="form-group row" style="display: flex; align-items: center">
              <div class="col-sm-12">
                <h6 class="modal-title">Người đánh giá: Nguyễn Văn Linh</h6>
                <h6 class="modal-title">Chức vụ: Giảng viên</h6>
                <h6 class="modal-title">Lớp: Xưởng lắp ráp ROBOT</h6>
                <h6 class="modal-title">Buổi học: 11/12</h6>
                <h6 class="modal-title">Ngày nhận xét: 22/8/2020</h6>
              </div>
            </div>
            <h5 class="col-sm-12" style="font-weight: bold;
