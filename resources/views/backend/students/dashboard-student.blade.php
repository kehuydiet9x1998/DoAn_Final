      ...
      <div class="page-wrapper">
        <div class="page-body">
          ...
          border-radius: 10px; margin-bottom: 10px; padding-top: 10px">
            <div class="col-xl-12"><h5>Khóa học: Xưởng lắp ráp ROBOT</h5></div>
          ...
          box-shadow: 0 0 5px 0 rgba(43,43,43,.1), 0 11px 6px -7px rgba(43,43,43,.1);
          border-radius: 10px; margin-bottom: 10px; padding-top: 10px">
            <div class="col-xl-12"><h5>Khóa học: Lập trình WEB với Python</h5></div>
            <div class="col-xl-4 col-md-6">
              <div class="card prod-p-card card-red">
                <div class="card-body">
                  <div class="row align-items-center m-b-30">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-lg-6">
              <div class="card">
                ...
                <div class="card-block">
                  ...
                  <canvas id="dihoc-chart" width="284" height="284" style="display: block; width: 284px; height: 284px;"></canvas>
                </div>
              </div>
            </div>
            {{--    Pie chart        --}}
            <div class="col-md-12 col-lg-6">
              <div class="card">
                ...
                <div class="card-block">
                  <iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; top: 0px; left: 0px; bottom: 0px; right: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                  <canvas id="pie-chart" width="284" height="284" style="display: block; width: 284px; height: 284px;"></canvas>
                </div>
              </div>
            </div>
          </div>
  ...
  <script>
    new Chart(document.getElementById("pie-chart"), {
      ...
      data: {
        ...
        datasets: [{
          label: "Điểm",
          backgroundColor: ["#464a49", "#888784","#dea11b","#db4141", "#1560cd","#4dd715","#841294","#cc83e5", "#e34e0e","#beee0f",],
