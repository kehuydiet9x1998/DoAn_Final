...
<script>
  ...
  $(document).ready(function() {
    $('#filter').click(function() {
      $('#tongluong').load('/administrators/payroll/tongluong/' + $('#doituong').val() + '/' + $('#thang').val());
    });
    if (!$('#thang').val())
    ...
    // $('#tongluong').load('/administrators/attendance/filter/nhanvien/' + $('#thang').val());
