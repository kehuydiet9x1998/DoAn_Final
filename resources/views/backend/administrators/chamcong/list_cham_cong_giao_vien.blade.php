...
<script>
  ...
  $(document).ready(function() {
    $('#filter').click(function() {
      $('#bangchamcong').load('/administrators/attendance/filter/giaovien/' + $('#ngaycham').val());
    });
...
<script>
  function confirm() {
    ...
    $.get('/administrators/attendance/confirm/' + id, function() {
      $('#filter').click();
    });
  }
  ...
  function cancel() {
    id = $(event.target).parent().data('id');
    $.get('/administrators/attendance/cancel/' + id, function() {
      $('#filter').click();
    });
