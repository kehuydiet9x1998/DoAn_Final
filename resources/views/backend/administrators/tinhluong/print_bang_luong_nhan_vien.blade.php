...
font-family:"Times New Roman",serif'>&nbsp;</span>
      ...
      <tr>
        ...
        <td style="padding:.75pt .75pt .75pt .75pt">
          <p align="center" style="text-align:center;line-height:150%">
            <strong>PHIẾU LƯƠNG NHÂN VIÊN</strong>
          </p>
          <p align="center" style="text-align:center;line-height:150%">
  ...
  0cm 5.4pt 0cm 5.4pt">
          <p class="MsoNormal" style="line-height:150%">
            <span style="font-size:12.0pt;
  line-height:150%">{{ $nhanvien->hodem. ' '. $nhanvien->ten }}</span>
          </p>
        </td>
      </tr>
      <tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt">
          <p class="MsoNormal" style="line-height:150%">
            <span style="font-size:12.0pt;
  line-height:150%">{{ $nhanvien->chucvu->ten }}</span>
          </p>
        </td>
      </tr>
      <tr>
  ...
  line-height:150%">{{ $luong->cong }}</span>
      ...
      <tr>
        <td rowspan="{{ 4+$nhanvien->dsphucap->count() }}" valign="top" style="border:solid #7F7F7F 1.0pt;padding:0cm 5.4pt 0cm 5.4pt">
          <p class="MsoNormal" align="center" style="text-align:center;line-height:150%">
  ...
  0cm 5.4pt 0cm 5.4pt">
          <p class="MsoNormal" style="line-height:150%">
            <span style="font-size:12.0pt;
  line-height:150%">Lương cơ bản</span>
          </p>
        </td>
        <td valign="top" style="border:solid #7F7F7F 1.0pt;border-left:none;padding:
  0cm 5.4pt 0cm 5.4pt">
          <p class="MsoNormal" style="line-height:150%">
            <span style="font-size:12.0pt;
  line-height:150%">{{ $nhanvien->chucvu->luongchinh }}</span>
          </p>
        </td>
      </tr>
  ...
  0cm 5.4pt 0cm 5.4pt">
          <p class="MsoNormal" style="line-height:150%">
            <span style="font-size:12.0pt;
  line-height:150%">Phụ cấp chức vụ</span>
          </p>
        </td>
        <td valign="top" style="border:solid #7F7F7F 1.0pt;border-left:none;padding:
  0cm 5.4pt 0cm 5.4pt">
          <p class="MsoNormal" style="line-height:150%">
            <span style="font-size:12.0pt;
  line-height:150%">{{ number_format($nhanvien->chucvu->phucap) }}</span>
          </p>
        </td>
      </tr>
