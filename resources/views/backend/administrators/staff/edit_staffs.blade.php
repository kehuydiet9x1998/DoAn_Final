<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form method="post" action="{{route('staffs.update', $staffs->id)}}" novalidate="">
        @method('PUT')
        <div class="modal-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="date" class="form-control" id="ngaysinh" name="ngaysinh" value="{{substr($staffs->ngaysinh ,0 ,10)}}">
              <span class="messages"></span>
            </div>
          </div>
          <div class="row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <select name="chuc_vu_id" class="form-control form-control-inverse">
                <option value="{{$staffs->chucvu->id}}">{{$staffs->chucvu->ten}}</option>
