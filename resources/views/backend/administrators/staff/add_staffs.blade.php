<div id="dom-table_filter" class="dataTables_filter" style="margin-left: -145px;">
  <li style="list-style: none">
    <button class="btn btn-success btn-round waves-effect waves-light" data-toggle="modal" data-target="#large-Modal" style="margin-top: -6px;height: 35px;line-height: 13px; margin-left: 5px; float: right">Thêm nhân viên</button>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="{{route('staffs.store')}}" novalidate="">
              <div class="modal-body">
