                          ...
                          <div class="col-sm-12">
                            <div>
                              <div class="card-header col-sm-12" style="text-align: center;">
                                ...
                                <h6 class="text-c-purple" style="margin-top: 10px;">Quản trị viên</h6>
                              ...
                              <div class="card-block">
                                <form id="main" method="post" action="https://colorlib.com/" novalidate="">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="password" class="form-control" id="password" name="password" placeholder="Mật khẩu hiện tại" value="{{$user->password}}">
                                      <span class="messages"></span>
                                    </div>
                                  </div>
                                  <div class="form-group row">
