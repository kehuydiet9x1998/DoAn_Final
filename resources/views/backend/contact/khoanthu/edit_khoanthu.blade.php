...
<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="tenkhoanthu" id="tenkhoanthu"
                placeholder="Nhập vào tên khoản thu" value="{{ $khoanthu->tenkhoanthu }}">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control autonumber" data-a-sep="," name="sotien" placeholder="Nhập số tiền"
                value="{{ number_format($khoanthu->sotien) }}">
              <span class="messages"></span>
            </div>
          </div>
          {{-- <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <select id="edit-hp" name="hoc_phi_id[]" class="selectpicker form-control form-control-primary fill"
          data-live-search="true" data-actions-box="true" title="-- Chọn học sinh --" multiple>
          @foreach($hocphis as $hocphi)
          <option @if($khoanthu_hocphi->contains(function ($value ,$key) use ($hocphi) { return $value->hoc_sinh_id ===
            $hocphi->hoc_sinh_id; })) selected @endif
