...
<td valign="top">
    ...
    <tbody>
      <tr>
        <td style="padding: 0in 5.4pt; width: 369.7pt;" width="493" valign="top">
          <p class="MsoNormal"><strong><span style="font-size: 10pt; font-family: Verdana;">Đơn vi: Học viện sáng tạo và công nghệ TEKY</span></strong></p>
  ...
  <p class="MsoNormal" style="text-indent: 0.5in;"><span style="font-size: 10pt; font-family: Verdana;">Họ và tên người nôp tiền:
      <b>{{ $phieuthu->hocphi->hocsinh->hodem .' '. $phieuthu->hocphi->hocsinh->ten}}</b>
    </span></p>
