<div class="modal fade show" id="suagv-Modal" tabindex="-1" role="dialog" style="z-index: 1050;display: none; padding-right: 17px;">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                ...
                <select name="select" class="form-control form-control-primary fill">
                  <option value="opt1">Chọn trạng thái giáo viên</option>
                  <option value="opt2">Giảng viên</option>
                  <option value="opt3">Thử việc</option>
                  <option value="opt4">Đã nghỉ làm</option>
                </select>
              </div>
            </div>
          </div>
