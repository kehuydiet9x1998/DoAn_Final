       ...
       <div class="modal-body">
         <form id="main" method="post" action="https://colorlib.com/" novalidate="">
           ...
           <div class="form-group row">
             ...
             <div class="col-sm-10">
               <input type="text" class="form-control" id="password" name="doituongnhanxet_id" value={{$nhanXet->doituongnhanxet_id}}
                 placeholder="Đối tượng nhận xét">
               <span class="messages"></span>
             </div>
           </div>
           <div class="form-group row">
             ...
             <div class="col-sm-10">
               <input type="date" class="form-control" id="repeat-password" name="thoigian"
                 placeholder="Thời gian nhận xét">
               <span class="messages"></span>
             </div>
           </div>
           <div class="form-group row">
