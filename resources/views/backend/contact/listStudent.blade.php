                        ...
                        <label style="display: flex">Search:<input type="search" class="form-control input-sm"
                          ...
                          <li>
                            <button class="btn btn-success btn-round waves-effect waves-light" data-toggle="modal"
                                    ...
                                    style="margin-top: -6px;height: 35px;line-height: 13px; margin-left: 5px">Thêm học viên</button>
                        ...
                        <tr>
                          ...
                          <td style="display: flex; width: 64px;">
                            ...
                            style="background-color: white; border: none; padding: 0;">
                              <i class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green" style="margin: 0"></i>
                            </button>
                            <!-- Modal Sua -->
