                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="display: flex; width: 64px;">
                          <li>
                            {{-- <button id="edit_buttonn" class="btn btn-success btn-round waves-effect waves-light"
                              data-toggle="modal" data-target="#edit-Modal"
                              style="margin-top: -6px;height: 35px;line-height: 13px; margin-left: 5px">Sửa</button> --}}
                            <button class="my_edit" data-id="{{$st->id}}" data-toggle="modal"
                                            ...
                                            <div class="form-check form-check-inline">
                                              <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="gioitinh"
                                                  id="gioitinh" value="Nam"> Nam
                                              </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                              <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="gioitinh"
                                                  id="gioitinh" value="Nữ"> Nữ
                                              </label>
                                            </div>
                                            <span class="messages"></span>
                                          </div>
                          ...
                          <!-- <button class="edit_button" data-id="{{$st->id}}" data-toggle="modal" data-target="#edit"><i class="icon feather icon-edit f-w-600 f-16 m-r-15 text-c-green"></i></button> -->

                          <form action="{{route('students.destroy', $st->id)}}" method="post">
                            @method('DELETE')
                            @csrf
                            {{-- <button type="button" class="btn btn-warning alert-confirm m-b-10"
                              onclick="if (!window.__cfRLUnblockHandlers) return false; _gaq.push(['_trackEvent', 'example', 'try', 'alert-confirm']);">Confirm</button> --}}
...
<script type="text/javascript" src="{{asset('asset/js/modaleffects.js')}}"></script> --}}
