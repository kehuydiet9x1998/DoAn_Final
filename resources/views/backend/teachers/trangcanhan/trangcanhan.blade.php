                                  ...
                                  <div class="col-lg-12 col-xl-6 ui-sortable-handle">
                                    <div class="card-sub">
                                      <div class="card-block" style="margin-top: -50px">
                                        <h6 class="card-title col-sm-auto" style="float: left; margin:0px 10px 0px 0px; padding: 0"><i class="fa fa-male"></i>CMND</h6>
                                        <h6 class="card-title">
                                          ...
                                          <div class="modal-body">
                                            <form method="post" action="{{route('phucap.store')}}" novalidate="" enctype="multipart/form-data">
                                              <div class="modal-body">
                                                ...
                                                @else
                                                <input type="hidden" name="giao_vien_id" value={{ $user->giaovien->id }}>
                            ...
                            <div class="card-block">
                              <div class="table-responsive">
                                <table class="table table-hover m-b-0" id="datatable">
                                  ...
                                  <tbody>
                                    @foreach($user->giaovien->dsphucap as $phucap)
                                    <tr>
                                      <td>{{$phucap->id}}</td>
                                      <td>
