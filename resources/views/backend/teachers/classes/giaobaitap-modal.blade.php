<div class="modal fade show" id="giaobaitap-Modal" tabindex="-1" role="dialog" style="z-index: 1050;display: none; padding-right: 17px;">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('danhsachbaitap.store')}}" method="POST">
        @csrf
                          ...
                          <td style="text-align: center">
                            <div class="checkbox-zoom zoom-success">
                              <label>
                                ...
                                <input type='hidden' name='chon_hoc_sinh[{{$diemdanh->hoc_sinh_id}}]' value="-1">
                                <input type="checkbox" checked name="chon_hoc_sinh[{{$diemdanh->hoc_sinh_id}}]" value="1">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="text-align: center">
                            <div class="checkbox-zoom zoom-success">
                              <label>
                                <input type="hidden" name="bai_tap_id[]" value="{{$baiTap->id}}">
                                <input type='hidden' name='chon_bai_tap[{{$baiTap->id}}]' value="-1">
                                <input type="checkbox" checked name="chon_bai_tap[{{$baiTap->id}}]" value="1"> <span class="cr"><i class="cr-icon icofont icofont-ui-check txt-success"></i></span>
                              </label>
                            </div>
                          </td>
                        </tr>
