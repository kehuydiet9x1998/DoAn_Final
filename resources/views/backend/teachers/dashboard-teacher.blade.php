                ...
                <div class="card-body">
                  <div class="row align-items-center m-b-30">
                    <div class="col">
                      ...
                      <h3 class="m-b-0 f-w-700 text-white">7</h3>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row align-items-center m-b-30">
                    <div class="col">
                      ...
                      <h3 class="m-b-0 f-w-700 text-white">2</h3>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-md-12 col-lg-6">
              <div class="card">
                ...
                <div class="card-block">
                  ...
                  <canvas id="line-chart" width="284" height="284" style="display: block; width: 284px; height: 284px;"></canvas>
                </div>
              </div>
            </div>
            {{--    Pie chart        --}}
